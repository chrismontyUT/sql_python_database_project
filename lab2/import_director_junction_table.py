...
def import_Director_Junction_Table():
    is_success = True
    insert_prefix = "insert into Director_Junction_Table (title, director_name) values ("
    ...
    try:
        ...
        is_success = False
        print "import_Director_Junction_Table Error: " + e.strerror
